...
public class GTCMaterialRecipeProv extends GTCRecipeProvider implements IGTCMaterialRecipeHelper {
    ...
    private void addMaterialSmeltery(Consumer<FinishedRecipe> consumer) {
        ...
        materialMeltingCasting(consumer, GTCMaterialIds.neutronium, GTMaterials.Neutronium.getFluid(),    folder);
        materialMeltingCasting(consumer, GTCMaterialIds.duranium, GTMaterials.Duranium.getFluid(),    folder);
    }
}
