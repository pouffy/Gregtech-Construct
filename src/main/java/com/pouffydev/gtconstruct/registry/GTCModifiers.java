...
import com.pouffydev.gtconstruct.common.modifier.BluntModifier;
...
public class GTCModifiers extends GTCModule {
    ...
    public static final StaticModifier<BluntModifier> blunt = MODIFIERS.register("blunt", BluntModifier::new);
